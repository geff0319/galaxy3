export default {
  ...
  plugins: {
    ...
    hub: 'Plugin-Hub',
    personalHub: 'Personal-Plugin-Hub',
    update: 'Update List',
  ...
  settings: {
    ...
    translate: {
      translate: 'translate',
      tencentTanslate: 'tencentTanslate',
      tencentTanslateSecretId: "tencentTanslateSecretId",
      tencentTanslateSecretKey: "tencentTanslateSecretKey"
    }
  },
  about: {
    new: 'New',
